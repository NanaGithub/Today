...
public class AttrsBean {
    private int[] initDate;//今日日历的年、月
    private List<int[]> specifyDate;//特殊日期的年、月
    ...
    private int todayBg = R.drawable.blue_circle;//今日选中的背景
    private int otherBg = R.drawable.blue_circle;//指定日期默认需要设置背景
    private Map<String, String> specifyMap;//指定日期对应的文字map
    private int chooseType = 0;//表示日历是单选还是多选

    public List<int[]> getSpecifyDate() {
        return specifyDate;
    }

    public void setSpecifyDate(List<int[]> specifyDate) {
    ...
    public int getOtherBg() {
        return otherBg;
    }

    public void setOtherBg(int otherBg) {
